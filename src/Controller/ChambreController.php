...
class ChambreController extends AbstractController
{
    ...
    #[Route('/nettoyer/{id}', name: 'app_chambre_nettoyer', methods: ['GET'])]
    public function nettoyerChambre(Request $request, Chambre $chambre, EntityManagerInterface $entityManager): Response
    {
        $chambre->setMenage(false);
